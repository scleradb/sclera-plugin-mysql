...
package com.scleradb.plugin.dbms.rdbms.mysql.test.service
...
import com.scleradb.plugin.dbms.rdbms.mysql.test.location.MySQLTest

class MySQLTestService extends DBService {
    override val id: String = MySQLTest.id
